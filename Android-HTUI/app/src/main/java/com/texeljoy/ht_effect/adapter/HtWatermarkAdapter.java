...
public class HtWatermarkAdapter extends RecyclerView.Adapter<HtStickerViewHolder> {
                ...
                public void onClick(View view) {
                    ...
                    if (htWatermark.isFromDisk()) {
                        if(holder.getAdapterPosition() == selectedPosition){
                            ...
                            BeautyManager.setARItemProperty(HTItemEnum.HTItemWatermark.getValue(), htWatermark.getName());
    ...
    public void selectItem(int selectedPosition) {
        ...
        BeautyManager.setARItemProperty(HTItemEnum.HTItemWatermark.getValue(), watermarkList.get(selectedPosition).getName());
        notifyItemChanged(selectedPosition);
        notifyItemChanged(lastPosition);
    }
}
