  ...
  protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull HtMakeupStyleConfig.HtMakeupStyle item) {
    ...
    holder.itemView.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        ...
        BeautyManager.setStyleProperty(item.getName(), HtUICacheUtils.getBeautyMakeUpStyleValue(item.getName()));
        Log.d("styleAda", "onClick: "+item.getName()+HtUICacheUtils.getBeautyMakeUpStyleValue(item.getName()));
