...
public class HtUICacheUtils {
    ...
    public static void initCache(boolean isFirstInit) {
        ...
        BeautyManager.setFilterProperty(HTFilterEnum.HTFilterBeauty.getValue(), getBeautyFilterName(), getBeautyFilterValue(getBeautyFilterName()));
        ...
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyClearSmoothing, beautySkinValue(HtBeautyKey.blurriness));
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautySkinRosiness, beautySkinValue(HtBeautyKey.rosiness));
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautySkinWhitening, beautySkinValue(HtBeautyKey.whiteness));
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyImageBrightness, beautySkinValue(HtBeautyKey.brightness) - 50);
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyImageSharpness, beautySkinValue(HtBeautyKey.clearness));
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyDarkCircleLessening, beautySkinValue(HtBeautyKey.undereye_circles));
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyNasolabialLessening, beautySkinValue(HtBeautyKey.nasolabial));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeEnlarging, beautyFaceTrimValue(HtFaceTrim.EYE_ENLARGING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeRounding, beautyFaceTrimValue(HtFaceTrim.EYE_ROUNDING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekThinning, beautyFaceTrimValue(HtFaceTrim.CHEEK_THINNING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekVShaping, beautyFaceTrimValue(HtFaceTrim.CHEEK_V_SHAPING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekNarrowing, beautyFaceTrimValue(HtFaceTrim.CHEEK_NARROWING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekboneThinning, beautyFaceTrimValue(HtFaceTrim.CHEEK_BONE_THINNING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeJawboneThinning, beautyFaceTrimValue(HtFaceTrim.JAW_BONE_THINNING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeChinTrimming, beautyFaceTrimValue(HtFaceTrim.CHIN_TRIMMING) - 50);
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeTempleEnlarging, beautyFaceTrimValue(HtFaceTrim.TEMPLE_ENLARGING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeHeadLessening, beautyFaceTrimValue(HtFaceTrim.head_lessening));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeFaceLessening, beautyFaceTrimValue(HtFaceTrim.FACE_LESSENING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeForeheadTrimming, beautyFaceTrimValue(HtFaceTrim.FOREHEAD_TRIM) - 50);
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseThinning, beautyFaceTrimValue(HtFaceTrim.NOSE_THINNING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeCornerEnlarging, beautyFaceTrimValue(HtFaceTrim.EYE_CORNER_ENLARGING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeSpaceTrimming, beautyFaceTrimValue(HtFaceTrim.EYE_SAPCING) - 50);
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeCornerTrimming, beautyFaceTrimValue(HtFaceTrim.EYE_CORNER_TRIMMING) - 50);
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseEnlarging, beautyFaceTrimValue(HtFaceTrim.NOSE_ENLARGING) - 50);
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapePhiltrumTrimming, beautyFaceTrimValue(HtFaceTrim.PHILTRUM_TRIMMING) - 50);
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseApexLessening, beautyFaceTrimValue(HtFaceTrim.NOSE_APEX_LESSENING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseRootEnlarging, beautyFaceTrimValue(HtFaceTrim.NOSE_ROOT_ENLARGING));
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeMouthTrimming, beautyFaceTrimValue(HtFaceTrim.MOUTH_TRIMMING) - 50);
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeMouthSmiling, beautyFaceTrimValue(HtFaceTrim.MOUTH_SMILING));
        ...
        for (int i = 0; i < 7; i++) {
            if (i >= 0 && i <= 2) {
                ...
                // BeautyManager.setMakeupProperty(i, "type", getMakeupItemNameOrTypeCache(i));
                // BeautyManager.setMakeupProperty(i, "color", getMakeupItemColorCache(i));

            } else {
                HTEffect.shareInstance().setMakeup(i, "name", getMakeupItemNameOrTypeCache(i));
                // BeautyManager.setMakeupProperty(i, "name", getMakeupItemNameOrTypeCache(i));
            }

            HTEffect.shareInstance().setMakeup(i, "value", String.valueOf(getMakeupItemValueCache(i, getMakeupItemNameOrTypeCache(i))));
            // BeautyManager.setMakeupProperty(i, "value", String.valueOf(getMakeupItemValueCache(i, getMakeupItemNameOrTypeCache(i))));
        }
        ...
        // BeautyManager.setChromaKeyingParamsProperty(0, 0);
        // BeautyManager.setChromaKeyingSceneProperty(1, 0);
        // BeautyManager.setChromaKeyingSceneProperty(2, 0);
        // BeautyManager.setChromaKeyingSceneProperty(3, 0);
        ...
        BeautyManager.setBodyProperty(HTBodyBeautyEnum.HTBodyBeautyLegSlimming.getValue(), beautyBodyValue(HtBody.LONG_LEG));
        BeautyManager.setBodyProperty(HTBodyBeautyEnum.HTBodyBeautyBodyThinning.getValue(), beautyBodyValue(HtBody.BODY_THIN));
    ...
    public static void applyHtCache() {
        ...
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautySkinWhitening, HtUICacheUtils.beautySkinValue(HtBeautyKey.whiteness));
        //磨皮
        ...
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyClearSmoothing, HtUICacheUtils.beautySkinValue(HtBeautyKey.blurriness));
        //红润
        // HTEffect.shareInstance().setBeauty(HtBeautyParam.HTBeautySkinRosiness, HtUICacheUtils.beautySkinValue(HtBeautyKey.rosiness));
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautySkinRosiness, HtUICacheUtils.beautySkinValue(HtBeautyKey.rosiness));
        //清晰
        ...
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyImageSharpness, HtUICacheUtils.beautySkinValue(HtBeautyKey.clearness));
        //亮度
        ...
        BeautyManager.setBeautyProperty(HtBeautyParam.HTBeautyImageBrightness, HtUICacheUtils.beautySkinValue(HtBeautyKey.brightness));
        //大眼
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeEnlarging, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.EYE_ENLARGING));
        //圆形眼
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeRounding, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.EYE_ROUNDING));
        //瘦脸
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekThinning, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.CHEEK_BONE_THINNING));
        //V脸
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekVShaping, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.CHEEK_V_SHAPING));
        //窄脸
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekNarrowing, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.CHEEK_NARROWING));
        //瘦颧骨
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekboneThinning, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.CHEEK_BONE_THINNING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeJawboneThinning, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.JAW_BONE_THINNING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeTempleEnlarging, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.TEMPLE_ENLARGING));
        //小头
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeHeadLessening, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.head_lessening));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeFaceLessening, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.FACE_LESSENING));
        //短脸
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeCheekShortening, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.CHEEK_SHORTENING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeChinTrimming, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.CHIN_TRIMMING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapePhiltrumTrimming, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.PHILTRUM_TRIMMING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeForeheadTrimming, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.FOREHEAD_TRIM));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeSpaceTrimming, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.EYE_SAPCING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeCornerTrimming, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.EYE_CORNER_TRIMMING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeEyeCornerEnlarging, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.EYE_CORNER_ENLARGING));
        //长鼻
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseEnlarging, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.NOSE_ENLARGING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseThinning, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.NOSE_THINNING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseApexLessening, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.NOSE_APEX_LESSENING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeNoseRootEnlarging, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.NOSE_ROOT_ENLARGING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeMouthTrimming, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.MOUTH_TRIMMING));
        ...
        BeautyManager.setReshapeProperty(HtBeautyParam.HTReshapeMouthSmiling, HtUICacheUtils.beautyFaceTrimValue(HtFaceTrim.MOUTH_SMILING));
